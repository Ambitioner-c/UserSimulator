...
from dialog_system import DialogManager, text_to_dict
from agents import AgentCmd, InformAgent, RequestAllAgent, RandomAgent, EchoAgent, RequestBasicsAgent, AgentDQN
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_turn', dest='max_turn', type=int,
                        default=20,
    ...
    parser.add_argument('--slot_err_prob', dest='slot_err_prob', type=float,
                        default=0.05,
                        help='the slot err probability')
    parser.add_argument('--slot_err_mode', dest='slot_err_mode', type=int,
                        default=0,
                        help='slot_err_mode: 0 for slot_val only; 1 for three errs')
    parser.add_argument('--intent_err_prob', dest='intent_err_prob', type=float,
                        default=0.05,
                        help='the intent err probability')
    
    parser.add_argument('--agt', dest='agt', type=int,
                        default=0,
                        help='Select an agent: 0 for a command line input, 1-6 for rule based agents')
    parser.add_argument('--usr', dest='usr', type=int,
                        default=0,
    ...
    parser.add_argument('--run_mode', dest='run_mode', type=int,
                        default=0,
    ...
    parser.add_argument('--cmd_input_mode', dest='cmd_input_mode', type=int,
                        default=0,
    ...
    parser.add_argument('--dqn_hidden_size', dest='dqn_hidden_size', type=int,
                        default=60,
    ...
    parser.add_argument('--gamma', dest='gamma', type=float,
                        default=0.9,
                        help='gamma for DQN')
    parser.add_argument('--predict_mode', dest='predict_mode', type=bool,
                        default=False,
    ...
    parser.add_argument('--warm_start_epochs', dest='warm_start_epochs', type=int,
                        default=100,
    ...
    parser.add_argument('--save_check_point', dest='save_check_point', type=int,
                        default=10,
    ...
    parser.add_argument('--split_fold', dest='split_fold', type=int,
                        default=5,
                        help='the number of folders to split the user goal')
    parser.add_argument('--learning_phase', dest='learning_phase', type=str,
                        default='all',
